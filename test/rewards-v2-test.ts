...
describe.only('CometRewardsV2', () => {
  describe('claim + supply', () => {
    it('can construct and claim rewards for owner with upscale', async () => {
      ...
      const txnV2 = await wait(rewardsV2.claimExt(
        comet.address,
        alice.address,
        true,
        0,
    ...
    it('does not overpay when claiming more than once', async () => {
      ...
      const txnV2_2 = await wait(rewardsV2.claimExt(
        comet.address,
        alice.address,
        true,
        0,
    ...
    it('fails if not enough rewards in the pool to transfer', async () => {
      ...
      await expect(rewardsV2.claimExt(
        comet.address,
        alice.address,
        true,
        0,
    ...
    describe('claimTo + borrow', () => {
      it('can construct and claim rewards to target with upscale', async () => {
        ...
        const txnV2 = await wait(rewardsV2.connect(bob).claimExtTo(
          comet.address,
          alice.address,
          bob.address,
          true,
      ...
      it('does not allow claiming more than once', async () => {
        ...
        const txnV2_2 = await wait(rewardsV2.connect(bob).claimExtTo(
          comet.address,
          alice.address,
          bob.address,
          false,
      ...
      it('fails if comet instance is not configured', async () => {
        ...
        await expect(
          rewardsV2.connect(bob).claimExtTo(
            protocol2.comet.address,
            alice.address,
            bob.address,
            true,
      ...
      it('fails if not enough rewards in the pool to transfer', async () => {
        ...
        await expect(rewardsV2.connect(bob).claimExtTo(
          comet.address,
          alice.address,
          bob.address,
          true,
    ...
    describe('getRewardOwed', () => {
      it('can construct and calculate rewards for owner with upscale', async () => {
        ...
        const result = await rewardsV2.callStatic.getRewardOwedExt(
          comet.address,
          0,
          COMP.address,
          alice.address,
      ...
      it('fails if comet instance is not configured', async () => {
        ...
        await expect(
          rewardsV2.getRewardOwedExt(protocol2.comet.address, 0, COMP.address, alice.address, 1000, 0)
          //).to.be.revertedWith(`custom error 'NotSupported("${comet.address}")`);
        ).to.be.revertedWithCustomError(rewardsV2, 'NotSupported').withArgs(protocol2.comet.address, ethers.constants.AddressZero);
      });
    });
    ...
    describe('setRewardsClaimed', () => {
      it('allows governor to set rewards claimed', async () => {
        ...
        const aliceRewardOwedV2COMP = await rewardsV2.callStatic.getRewardOwedExt(
          comet.address,
          0,
          COMP.address,
          alice.address,
        ...
        const aliceRewardOwedV2USDC = await rewardsV2.callStatic.getRewardOwedExt(
          comet.address,
          0,
          USDC.address,
          alice.address,
        ...
        const bobRewardOwed2COMP = await rewardsV2.callStatic.getRewardOwedExt(
          comet.address,
          0,
          COMP.address,
          alice.address,
        ...
        const bobRewardOwed2USDC = await rewardsV2.callStatic.getRewardOwedExt(
          comet.address,
          0,
          USDC.address,
          alice.address,
      ...
      //       (await getBlock()).timestamp - timestampPreTxn;
